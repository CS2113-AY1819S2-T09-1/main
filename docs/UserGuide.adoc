...
* All the module(s) to add must exist in the module list.
...
Adds module CS1231 and CS2040C to year 1 semester 4 (special term semester 2) of the degree plan.

* `planner_add year/1 sem/2 code/CS2113T code/CS2107` +
Adds module CS2113T and CS2107 to year 1 semester 2 of the degree plan.
...
Removes module CS2100 and CS2040C from the degree plan.
