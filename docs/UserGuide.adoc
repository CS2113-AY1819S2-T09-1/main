...
Format: `planner add MODULE_CODE`
...
=== Toggling an existing module in the planner to be exempted: `planner exempt MODULE_CODE`

Toggles an existing module in the planner to be exempted so that the planner can suggest modules
accordingly

Examples:

* `planner exempt CS1231`
...
=== Displaying the entire module planner : `planner list`

Displays the entire module planner

=== Displaying the entire module planner in tree format : `planner list-tree`

Displays the entire module planner in tree format

===  Auto-generating the entire module plan and display the result : `planner generate`

Auto-generates the entire module plan and display the result
...
* *Undo* : `undo`
* *Redo* : `redo`
* *Planner add* : `planner add`
e.g. * `planner add CS1231`
* *Planner delete* : `planner delete`
e.g. * `planner delete CS1231`
* *Planner move* : `planner move MODULE_CODE SEMESTER`
e.g. * `planner move CS1231 Y1S2`
* *Planner exempt* : `planner exempt MODULE_CODE`
e.g. * `planner exempt CS1231`
* *Planner list* : `planner list`
* *Planner list-tree* : `planner list-tree`
* *Planner susggest* : `planner suggest`
