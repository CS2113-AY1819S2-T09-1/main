...
=== Adding one/multiple modules to the degree plan : `planner_add` `[coming in v2.0]`

Adds one/multiple existing modules to the degree plan. +
Format: `planner_add code/CODE [code/CODE]… year/YEAR sem/SEMESTER`
...
* All the modules to add must exist in the application.
* After adding, the changes will be reflected in the degree plan accordingly.

Examples:

* `planner_add code/CS1010 year/3 sem/2` +
Adds module CS1010 to year 3 semester 2 of the degree plan.

* `planner_add code/CS1231 code/CS2040C year/1 sem/2` +
Adds modules CS1231 and CS2040C to year 1 semester 2 of the degree plan.

* `planner_add code/CS2113T code/CS2040C code/CS2107 year/1 sem/3` +
Adds modules CS2113T, CS2040C and CS2107 to year 3 special term semester 1 of the degree plan.

=== Deleting modules from the degree plan : `planner_delete` `[coming in v2.0]`

Deletes one/multiple existing modules from the degree plan. +
Format: `planner_delete code/CODE [code/CODE]…`

* All the modules to delete must exist in the degree plan.
* After deleting, the changes will be reflected in the degree plan accordingly.

Examples:

* `planner_delete code/CS1231` +
Deletes module CS1231 from the degree plan.

* `planner_delete code/CS2100 code/CS2040C` +
Deletes modules CS2100 and CS2040C from the degree plan.
...
* *Undo* : `undo`
* *Redo* : `redo`
* *Add one/multiple modules to degree plan* : `planner_add code/CODE [code/CODE]… year/YEAR sem/SEMESTER` +
e.g.  `planner_add code/CS1010 code/CS2113T year/1 sem/2`
* *Delete one/multiple modules from degree plan* : `planner_delete code/CODE [code/CODE]…` +
e.g.  `planner_delete code/CS1231 code/CS1010`
