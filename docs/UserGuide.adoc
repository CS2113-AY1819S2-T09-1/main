...
* `planner_add code/CS1010 year/1 sem/3` +
Adds module CS1010 to year 1 special term semester 1 of the degree plan.
...
* `planner_add code/CS2113T code/CS2107 year/1 sem/2` +
Adds modules CS2113T and CS2107 to year 1 semester 2 of the degree plan.

=== Deleting one/multiple modules from the degree plan : `planner_remove` `[coming in v2.0]`
