...
* All the module/modules to add must exist in the module list.
...
* `planner_add code/CS1231 code/CS2040C year/1 sem/4` +
Adds modules CS1231 and CS2040C to year 1 special term semester 2 of the degree plan.
...
=== Deleting modules from the degree plan : `planner_remove` `[coming in v2.0]`
...
* *Delete one/multiple modules from degree plan* : `planner_remove code/CODE [code/CODE]…` +
