...
=== Adding modules to the degree planner : `planner_add` `[coming in v2.0]`

Adds existing modules to the degree planner. +
...
Adds module CS1010 to year 3 semester 2 of the degree planner.

* `planner_add code/CS1231 code/CS2040C year/1 sem/2` +
Adds modules CS1231 and CS2040C to year 1 semester 2 of the degree planner.

* `planner_add code/CS2113T code/CS2040C code/CS2107 year/1 sem/3` +
Adds module code CS2113T, CS2040C and CS2107 to year 3 special semester 1 of the degree planner.

=== Deleting modules from the degree planner : `planner_delete` `[coming in v2.0]`

Deletes a set of existing modules from the degree planner. +
Format: `planner_delete code/CODE [code/CODE]…`

* All the modules to delete must exist in the degree planner.
* After deleting, the changes will be reflected in the degree planner accordingly.

Examples:

* `planner_delete code/CS1231` +
Deletes module CS1231 from the degree planner.

* `planner_delete code/CS2100 code/CS2040C` +
Deletes modules CS2100 and CS2040C from the degree planner.
...
* *Undo* : `undo`
* *Redo* : `redo`
* *Add module to degree planner* : `planner_add code/CODE [code/CODE]… year/YEAR sem/SEMESTER` +
e.g.  `planner_add code/CS1010 code/CS2113T year/1 sem/2`
* *Delete module from degree planner* : `planner_delete code/CODE [code/CODE]…` +
