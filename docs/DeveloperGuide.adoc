...
[none]
** 1b1. Application shows an error message that the module(s) specified by user already exists in degree plan.
*** 1b1a. In cases where step 1b takes place simultaneously with step 1c, step 1c1 will not take place.
+
Use case ends.
...
*** 1c1a. In cases where step 1b takes place simultaneously with step 1c, step 1c1 will not take place.
+
Use case ends.
