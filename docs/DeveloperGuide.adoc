...
[discrete]
=== Use case: Add modules to degree planner

*MSS*

1. User requests to add a set of modules to the Application's degree planner
2. Application adds the modules into the degree planner
+
Use case ends.
...
+
Use case ends.
* 1b. Any of the modules already exist in the degree planner.
[none]
** 1b1. Application shows an error message that some of the modules specified by user already exist in degree planner.
+
Use case ends.

[discrete]
=== Use case: Delete modules from degree planner
...
3.  User requests to delete modules from the degree planner
4.  Application deletes the modules from the degree planner
+
Use case ends.
...
+
Use case resumes at step 2.
* 3b. Any of the modules do not exist in the degree planner.
[none]
** 3b1. Application shows an error message that some of the modules specified by user do not exist in degree planner.
+
Use case resumes at step 2.
