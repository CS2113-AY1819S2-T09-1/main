...
[none]
** 1b1. Application shows an error message that the module(s) specified by user already exist in degree plan.
** 1b2. In cases where step 1b takes place simultaneously with step 1c, step 1c1 will not take place.
+
Use case ends.
* 1c. The module(s) does not exist in the module list.
[none]
** 1c1. Application shows an error message that the module(s) specified by user do not exist in the module list.
** 1c2. In cases where step 1b takes place simultaneously with step 1c, step 1c1 will not take place.
+
Use case ends.
...
[none]
** 3b1. Application shows an error message that the module(s) specified by user does not exist in degree plan.
+
Use case resumes from step 2.
