...
|`* * *` |user |remove modules from my degree planner |ensure that the modules in my degree planner are the right ones
...
+
Use case ends.
* 1b. The modules already exist in the degree planner.
[none]
** 1b1. Application shows an error message that modules specified by user already exists in degree planner.
+
Use case ends.
...
3.  User requests to delete a set of modules from the degree planner
4.  Application deletes the set of modules from the degree planner
+
Use case ends.
