...
|`* * *` |user |remove modules from my degree planner |remove modules that I am not interested in taking
from my degree planner
...
[discrete]
=== Use case: Add one/multiple modules to degree plan

*MSS*

1. User requests to add one/multiple modules to the Application's degree plan
2. Application adds the module/modules into the degree plan
+
Use case ends.
...
+
Use case ends.
* 1b. Any of the modules already exists in the degree plan.
[none]
** 1b1. Application shows an error message that one/some of the modules specified by user already exist in degree plan.
+
Use case ends.
* 1c. Any of the modules does not exist in the module list.
[none]
** 1c1. Application shows an error message that one/some of the modules specified by user do not exist in the module list.
+
Use case ends.

[discrete]
=== Use case: Delete one/multiple modules from degree plan

*MSS*

1.  User requests to list modules in the Application's degree plan
2.  Application shows a list of modules in the degree plan
3.  User requests to delete one/multiple modules from the degree plan
4.  Application deletes the module/modules from the degree plan
+
Use case ends.
...
+
Use case resumes at step 2.
* 3b. Any of the modules do not exist in the degree plan.
[none]
** 3b1. Application shows an error message that one/some of the modules specified by user do not exist in degree plan.
+
Use case resumes at step 2.
